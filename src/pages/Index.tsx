    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-blue-900/20">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-gray-600 hover:bg-gray-700 text-lg px-8 py-4"
          ...
          <div className="mt-16 relative">
            <div className="w-full h-64 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-2xl border border-gray-700 flex items-center justify-center">
      ...
      <section id="how-it-works" className="py-20 px-4 bg-gray-900/50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-16 text-lg">Four simple steps to automate anything</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-gray-700 hover:border-gray-600 transition-all group">
            ...
            {[
              ...
              <div key={index} className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-gray-700">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-auto bg-purple-500/20 text-purple-400 px-2 py-1 rounded text-xs">
